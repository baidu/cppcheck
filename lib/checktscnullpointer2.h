#ifndef BCACPP_CHECKTSCNULLPOINTER2_H
#define BCACPP_CHECKTSCNULLPOINTER2_H
...
public:
    ...
    bool get_possible() const { return m_possible; }
...
public:
    ...
    void set_possible(bool possible)
    {
        Info.set_possible(possible);
    }

    bool IsCertain() const
    {
        return (!Info.GetUnknown() && !Info.get_possible());
    }
...
/// @addtogroup Checks
/// @{
class CPPCHECKLIB CheckTSCNullPointer2 : public Check {
public:
...
private:
    ...
    inline bool check_if_lib_function_return_null(const Token* const pToken) const;
    ...
    inline bool get_lib_not_null_param_index_by_name(std::set<int> &derefIndex, const Token *tok) const;
...
#endif // BCACPP_CHECKTSCNULLPOINTER2_H
