#ifndef BCACPP_CHECKTSCSUSPICIOUS_H
#define BCACPP_CHECKTSCSUSPICIOUS_H
...
public:
    ...
    CheckTSCSuspicious(const Tokenizer *tokenizer, const Settings *settings,
        ErrorLogger *errorLogger)
        : Check(myName(), tokenizer, settings, errorLogger) { }

    /** @brief Run checks against the normal token list */
    void runChecks(const Tokenizer *tokenizer, const Settings *settings,
        ErrorLogger *errorLogger) {
    ...
    void unsafeFunctionUsageError(const Token *tok, const std::string& unsafefuncname,
        const std::string& safefuncname);
...
#endif // BCACPP_CHECKTSCSUSPICIOUS_H